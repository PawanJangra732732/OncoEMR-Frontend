...
//     document.getElementById("txtMDUID").value = event.target.value;
//   };
...
//         <option value="UID_060Z6BZZDCC3FY0987Y4">Ali, NP, Jessica Fay</option>
//         <option value="UID_Az86426924_1451">Gelfand, MD, Robert</option>
//         <option value="UID_066ATE4VW2A49WWGN5KW">Ghuman, MD, Damanjit</option>
//         <option value="UID_VV664631032_1165">Kramer, MD, Rachel</option>
//         <option value="UID_VV370565293_2160">Livescu, NP, Nicole</option>
//         <option value="UID_BD366072840_4">Siddiqui MD, Ayesha</option>
//       </select>
//       <input type="text" id="txtMDUID" className="p-2 mt-2 border border-gray-300 rounded" />
//     </div>
//   );
// };
...
const PhysicianForm = () => {
  return (
    <div className="max-w-full">
      <form className="max-w-fit mx-auto p-6 bg-white shadow-md rounded">
